...
from algos.recursion import factorial, is_palindrome, power, product_of_array, flatten_array, bunny_ears, count_7, count_abc, all_star, no_x
...
test('all_star_recursion', all_star('abc'), 'a*b*c')
test('all_star_recursion', all_star('123456'), '1*2*3*4*5*6')
test('no_x', no_x('abcdexf'), 'abcdef')
test('no_x', no_x('axxx1'), 'a1')
